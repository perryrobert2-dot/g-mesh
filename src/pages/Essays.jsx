  ...
  return (
    <div className="grid-bg min-h-screen px-8 pt-32 max-w-7xl mx-auto">
      ...
      <div className="space-y-4 max-w-3xl">
        ...
        <Link to="/the" className="block p-6 bg-surface/50 border border-border hover:border-primary transition-colors">
          <span className="text-[10px] font-bold text-primary uppercase tracking-widest block mb-2">System Signal // Cultural Parallel</span>
          <h2 className="text-xl font-bold text-text-main">The Map and the Mirror</h2>
          <p className="text-sm text-text-muted mt-2">Mapping the systems being built and mocking the ones trying to take the driver's seat.</p>
        </Link>
      </div>
